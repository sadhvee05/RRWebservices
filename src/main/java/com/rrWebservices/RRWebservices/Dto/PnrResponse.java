...
public class PnrResponse {
	...
	public String toString() {
		return "PnrResponse [sourceStation=" + sourceStation + ", destinationStation=" + destinationStation
				+ ", trainNumber=" + trainNumber + ", trainName=" + trainName + ", dateOfJourney=" + dateOfJourney
				+ ", arrivalDate=" + arrivalDate + ", noOfPassengers=" + noOfPassengers + ", guestsInfo=" + guestsInfo
				+ "]";
	}
	public PnrResponse(String sourceStation, String destinationStation, String trainNumber, String trainName,
			LocalDateTime dateOfJourney, LocalDateTime arrivalDate, int noOfPassengers, List<GuestInfoDto> guestsInfo) {
		super();
		this.sourceStation = sourceStation;
		this.destinationStation = destinationStation;
		this.trainNumber = trainNumber;
